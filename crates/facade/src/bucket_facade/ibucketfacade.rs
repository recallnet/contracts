...
pub mod IBucketFacade {
    ...
    /**```solidity
struct AddObjectParams { bytes32 source; string key; bytes32 hash; bytes32 recoveryHash; uint64 size; uint64 ttl; KeyValue[] metadata; bool overwrite; }
```*/
        ...
        impl alloy_sol_types::SolStruct for AddObjectParams {
            ...
            fn eip712_root_type() -> alloy_sol_types::private::Cow<'static, str> {
                alloy_sol_types::private::Cow::Borrowed(
                    "AddObjectParams(bytes32 source,string key,bytes32 hash,bytes32 recoveryHash,uint64 size,uint64 ttl,KeyValue[] metadata,bool overwrite)",
                )
            }
            #[inline]
...
```*/
    ...
    /**Function with signature `addObject((bytes32,string,bytes32,bytes32,uint64,uint64,(string,string)[],bool))` and selector `0x889f48a1`.
```solidity
function addObject(AddObjectParams memory params) external;
```*/
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    ...
    pub struct addObject_1Call {
        #[allow(missing_docs)]
        pub params: <AddObjectParams as ::alloy_sol_types::SolType>::RustType,
    }
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for addObject_1Call {
            ...
            const SELECTOR: [u8; 4] = [136u8, 159u8, 72u8, 161u8];
            #[inline]
            fn new<'a>(
                tuple: <Self::Parameters<'a> as alloy_sol_types::SolType>::RustType,
            ) -> Self {
            ...
            #[inline]
            fn tokenize(&self) -> Self::Token<'_> {
                (<AddObjectParams as alloy_sol_types::SolType>::tokenize(&self.params),)
            }
            #[inline]
            fn abi_decode_returns(
                data: &[u8],
