...
impl Into<ListParams> for IBucketFacade::queryObjects_2Call {
    fn into(self) -> ListParams {
        ListParams {
            prefix: self.prefix.into_bytes(),
...
impl TryAbiEncodeReturns<ListObjectsReturn> for IBucketFacade::queryObjects_2Call {
    fn try_returns(&self, value: ListObjectsReturn) -> Result<Vec<u8>, AbiEncodeError> {
        let query = convert_list_objects_to_query(value)?;
        Ok(Self::abi_encode_returns(&(query,)))
    }
...
impl Into<ListParams> for IBucketFacade::queryObjects_4Call {
    fn into(self) -> ListParams {
        ListParams {
            prefix: self.prefix.into_bytes(),
            delimiter: self.delimiter.into_bytes(),
...
impl TryAbiEncodeReturns<ListObjectsReturn> for IBucketFacade::queryObjects_4Call {
    fn try_returns(&self, value: ListObjectsReturn) -> Result<Vec<u8>, AbiEncodeError> {
        let query = convert_list_objects_to_query(value)?;
        Ok(Self::abi_encode_returns(&(query,)))
    }
