...
import {LibBucket} from "../src/util/LibBucket.sol";
...
contract LibBucketTest is Test {
    ...
    function testDecodeList() public view {
        ...
        // 1 bucket
        machines = LibBucket.decodeList(hex"81836b4f626a65637453746f72655502770d21925703390a236f68f84ef1d432ca5742c4a0");
