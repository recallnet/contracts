...
contract LibWasmTest is Test {
    ...
    //     // 40 bits
    //     require(LibWasm.decodeCborBigIntToUint256(hex"8201821a000000001801") == 4294967296, "it should be
    // 4294967296");
    //     require(
    //         LibWasm.decodeCborBigIntToUint256(hex"8201821affffffff18ff") == 1099511627775, "it should be
    // 1099511627775"
    //     );
    //     // 48 bits
    //     require(LibWasm.decodeCborBigIntToUint256(hex"8201821a00000000190001") == 4294967296, "it should be
    // 4294967296");
    //     require(
    ...
    //     // 64 bits
    //     require(
    //         LibWasm.decodeCborBigIntToUint256(hex"8201821a000000001a00000001") == 4294967296, "it should be
    // 4294967296"
    //     );
    //     require(
    ...
    //     bytes memory expectedError = abi.encodeWithSelector(InvalidValue.selector, "Invalid array length or sign
    // value");
